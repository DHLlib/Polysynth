...
<p align="center">
  <b>多 LLM Agent 协作讨论模拟器 / Multi-LLM Agent Collaborative Discussion Simulator</b>
</p>
...
| 文档 | 说明 |
|------|------|
| [docs/architecture.md](docs/architecture.md) | 系统架构、数据流、扩展指南 |
| [docs/features.md](docs/features.md) | 功能概览、使用场景、配置参考 |
| [docs/api-contract.md](docs/api-contract.md) | REST API、WebSocket 协议、组件接口 |
